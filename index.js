...
const config = {
    A187: '📍BOT DO LOSER777📍',
    instagram: 'https://instagram.com/_saron777?igshid=yeojol4phbfm',
    nomer: 'wa.me/+5568992150341',
    aktif: '24 JAM',
    youtube: '',
    whatsapp: '',
      ...
      case 'stickergif':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    ...
                    client.reply(from, '[❗] Enviar vídeo com legenda *!stickerGif* max 10 sec!', id)
                )
            }
            break     
     case 'sticker':
